  ...
  return (
    <div className="signupform__card">
      ...
      <div className="signupform__login">
        Have an account?{' '}
        <button type="button" className="signupform__login-btn" onClick={onSwitchToLogin}>
          Sign In
        </button>
      </div>

      {/* Only one form tag below */}
      <form onSubmit={handleSubmit}>
        ...
        <div className="signupform__field">
          ...
          <div className="signupform__label">
            <span className="signupform__label-dashes"></span>
            <label className="signupform__label-text" htmlFor="signup-password">
              Password
            </label>
            <span className="signupform__label-dashes"></span>
          </div>
        ...
        <div className="signupform__field">
          ...
          <div className="signupform__label">
            <span className="signupform__label-dashes"></span>
            <label className="signupform__label-text" htmlFor="signup-password-retype">
              Retype Password
            </label>
            <span className="signupform__label-dashes"></span>
          </div>
